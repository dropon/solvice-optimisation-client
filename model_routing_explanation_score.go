...
// checks if the RoutingExplanationScore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingExplanationScore{}

// RoutingExplanationScore Score of the solution.
type RoutingExplanationScore struct {
...
func (o *RoutingExplanationScore) SetHardScoreNil() {
	o.HardScore.Set(nil)
}
...
func (o *RoutingExplanationScore) SetMediumScoreNil() {
...
func (o *RoutingExplanationScore) SetSoftScoreNil() {
	o.SoftScore.Set(nil)
}
...
func (o *RoutingExplanationScore) SetFeasibleNil() {
	o.Feasible.Set(nil)
}
...
func (o RoutingExplanationScore) MarshalJSON() ([]byte, error) {
...
func (o RoutingExplanationScore) ToMap() (map[string]interface{}, error) {
...
type NullableRoutingExplanationScore struct {
	value *RoutingExplanationScore
	isSet bool
}

func (v NullableRoutingExplanationScore) Get() *RoutingExplanationScore {
	return v.value
}

func (v *NullableRoutingExplanationScore) Set(val *RoutingExplanationScore) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingExplanationScore) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingExplanationScore) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingExplanationScore(val *RoutingExplanationScore) *NullableRoutingExplanationScore {
	return &NullableRoutingExplanationScore{value: val, isSet: true}
}

func (v NullableRoutingExplanationScore) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingExplanationScore) UnmarshalJSON(src []byte) error {
	v.isSet = true
